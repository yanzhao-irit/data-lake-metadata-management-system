...
$(function () {
  ...
  $('.names').on('click', "td", function () {
    ...
    if ($(this).context.className == "Process") {
      ...
      /*console.log("Query2")
      console.log(query2)*/
      api.getHyperGraphe(query2).then(p =>{
        if(p.length == 0){
          ...
          var nodes = new vis.DataSet(p[length][0]);
          // create an array with edges
          var edges = new vis.DataSet(p[length][1]);
      ...
      if ($(this).context.className == "Study") {
        ...
        if ($(this).context.className == "Database") {
          ...
          console.log("Query5")
          api.getRelationshipAttribute(query5).then(p =>{
            if(p.length == 0){
          ...
          /*console.log("query4")
          console.log(query4)*/
          api.getRelationshipDataset(query4).then(p =>{
            // console.log(p)
            if(p.length == 0){
